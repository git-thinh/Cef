...
namespace CefSharp.Example
{
    public static class CefExample
    {
        ...
        public static void Init_Ocr(AbstractCefSettings settings, IBrowserProcessHandler browserProcessHandler)
        { 
            if (DebuggingSubProcess)
            {
                //var architecture = Environment.Is64BitProcess ? "x64" : "x86";
            ...
            Cef.AddCrossOriginWhitelistEntry(BaseUrl, "https", "cloud.google.com", false);
        }
        ...
        public static void Init(AbstractCefSettings settings, IBrowserProcessHandler browserProcessHandler)
        {
            ...
            settings.RegisterScheme(new CefCustomScheme
            {
                ...
                SchemeHandlerFactory = new FolderSchemeHandlerFactory(
                    //rootFolder: @"..\..\..\..\CefSharp.Example\Resources",
                    rootFolder: @"..\test",
